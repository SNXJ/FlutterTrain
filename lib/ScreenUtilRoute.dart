...
class ScreenUtilRoute extends StatefulWidget {
  @override
  _ScreenUtilRouteState createState() {
    return _ScreenUtilRouteState();
  }
}

class _ScreenUtilRouteState extends State<ScreenUtilRoute> {
  ...
  Widget build(BuildContext context) {
    ...
    print(
        '状态栏高度:${ScreenUtil
            .statusBarHeight}px'); //Status bar height , Notch will be higher Unit px
      ...
      body: new Center(
        child: Column(
          ...
          children: <Widget>[
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: ScreenUtil().setSp(30, true),
                    ),
                  ),
                  ),
            ...
            Text(
              '宽度和字体相对于设计稿放大的比例:${ScreenUtil().scaleWidth *
